package xyz.teamprojectx.weather.data.viewModel

import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import androidx.lifecycle.viewModelScope
import kotlinx.coroutines.launch
import xyz.teamprojectx.weather.data.network.ApiException
import xyz.teamprojectx.weather.data.network.ApiExceptionNoInternet
import xyz.teamprojectx.weather.data.network.Resource
...
import xyz.teamprojectx.weather.data.request.ResponseAbout
import xyz.teamprojectx.weather.data.response.*
import xyz.teamprojectx.weather.data.response.blog.ResponseBlogs
...
class ExploreViewModel(val repository: ExploreRepository) : ViewModel() {
    ...
    val weatherResponse:MutableLiveData<Resource<ResponseWeather>> = MutableLiveData()
